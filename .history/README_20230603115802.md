...
<h3 align="center">Game Hub - Cross Course Assignment</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/runeunhjem/gamehub-wp-ca"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
[![Product Name Screen Shot][product-screenshot]](https://gamehub-wp-ca.netlify.app)
...
2. Clone the repo
   ```sh
   git clone https://github.com/runeunhjem/gamehub-wp-ca.git
   ```
3. Start working
...
Buy and sell your games at good prices. Search, filter and sort through the games to find the best deals.

Find the latest and greatest version of the site at [https://gamehub-wp-ca.netlify.app](https://gamehub-wp-ca.netlify.app)
...
- [ ] Figma design before starting in VSC
- [ ] Make the Header
- [ ] Make the Footer
- [ ] About page
- [ ] Contact page
- [ ] Games page
    -  First local, then API
    -  Added search, filter and sort
    -  Added featured games & thumbnails
- [ ] Game specific details page

See the [open issues](https://github.com/runeunhjem/gamehub-wp-ca/issues) for a full list of proposed features (and known issues).
...
<!-- CONTACT -->
## Contact
Project Link: [https://github.com/runeunhjem/gamehub-wp-ca](https://github.com/runeunhjem/gamehub-wp-ca)
